      ...
      server.middlewares.use(async (req, res, next) => {
        ...
        const defaultMockFiles = [
          ...
          },
          {
            ...
            full_path: '/系统架构与分布式/PostgreSQL 15 高性能架构与内核源码剖析.pdf',
            share_code: 'sw398cslearning',
            receive_code: 'cs24',
            share_title: '计算机核心课程架构师进阶与经典电子书精选',
          },
          ...
          },
          {
            ...
            full_path: '/电影原声OST与高保真古典/Hans Zimmer - Live in Prague (24bit-96kHz Hi-Res FLAC).flac',
            share_code: 'sw377flachifi',
            receive_code: '',
            share_title: '母带级 Hi-Res 24bit/96kHz 无损音乐精选集',
          },
          {
            ...
            parent_115_id: 'cid_3001',
            name: 'Beethoven - Symphony No.9 in D minor Op.125 (Karajan 24bit-96kHz).flac',
            extension: 'flac',
            size: 1572864000,
            is_dir: false,
            sha1: 'E1234567890ABCDEF1234567890ABCDEF1234567',
            full_path: '/电影原声OST与高保真古典/Beethoven - Symphony No.9 in D minor Op.125 (Karajan 24bit-96kHz).flac',
            share_code: 'sw377flachifi',
            receive_code: '',
            share_title: '母带级 Hi-Res 24bit/96kHz 无损音乐精选集',
          }
